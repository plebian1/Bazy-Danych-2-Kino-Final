...
/**
 * Servlet implementation class SeansManagerServlet
 */
@WebServlet("/Manager/seansManagement2")
public class SeansManagerServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private SeansManagerDAO seansDAO;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeansManagerServlet2() {
        super();
	...
	private void listSeanse(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("seansManagement2.jsp");
