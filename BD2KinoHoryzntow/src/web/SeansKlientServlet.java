 ...
 */
@WebServlet("/User/SeansKlient")
public class SeansKlientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private SeansKlientDAO seansDAO;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeansKlientServlet() {
        super();
	...
	private void listSeanse(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("repertuar.jsp");
